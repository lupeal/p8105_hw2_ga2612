...
The resulting dataset contains a total of `r nrow(baseline_demos)` observations and `r ncol(baseline_demos)` variables. There was a total of 483 participants recruited and of those `r nrow(baseline_demos)` developed MCI. The average baseline age was `r baseline_demos %>% mean(baseline_age)`. The proportion of women in the study that were APOE4 carriers were `r baseline_demos %>% filter(sex == 'female' & apoe4_carrier == "carrier") %>% sum(id)` / `r nrow(baseline_demos)`.  
